...
Mobile.setText(findTestObject('Application/App/Activity/Input Phone Number/android.widget.EditTextPhoneNumber'), '0821746201', 
    10)
...
Mobile.checkElement(findTestObject('Application/App/Activity/Input Pin/android.widget.ButtonCobaLagi'), 20)
